...
class Auth {
    ...
    final String? id;
    final Group? person;
    final Group? business;

    factory Auth.fromJson(Map<String, dynamic> json){ 
        return Auth(
            id: json["id"],
            person: json["person"] == null ? null : Group.fromJson(json["person"]),
            business: json["business"] == null ? null : Group.fromJson(json["business"]),
        );
    }
